...
class Player(GameSprite):
    ...
    def load_animation(self):
        sheet_right = image.load("images/hero1.png").convert_alpha()
        frame_width = 24
        frame_height = 24
        self.frames_right = [
    ...
    def fire(self):
        bullet = Bullet('images/proxy-image.png', self.rect.centerx, self.rect.top, 15, 20, 15)
        bullets.add(bullet)
...
display.set_icon(image.load("images/start.jpg"))

back_m = transform.scale(image.load("images/background.jpg"), (win_width, win_height))
start_but = GameSprite("images/start.jpg", 1000, 10, 200, 80)
exit_but = GameSprite("images/exit.png", 0, 10, 200, 80)
mus_but = GameSprite("images/removem.png", 1000, 600, 80, 80)
...
back = transform.scale(image.load("images/background.jpg"), (win_width, win_height))
...
hero = Player('images/hero11.png', 5, win_height - 80, 80, 80, 0, 0)
...
monster2 = Enemy_h('images/enemy.png', 0, 150, 80, 80, 5, 0, 200)
monsters.add(monster1)
monsters.add(monster2)

coin1 = GameSprite('images/coin.jpg', 400, 200, 80, 80)
coin2 = GameSprite('images/coin.jpg', 200, 600, 80, 80)
coins.add(coin1)
coins.add(coin2)
...
back_2 = transform.scale(image.load("images/bg2.jpg"), (win_width, win_height))
barriers_2 = sprite.Group()
monsters_2 = sprite.Group()
coins_2 = sprite.Group()


hero_2 = Player('images/hero11.png', 5, 5, 80, 80, 0, 0)
final_sprite_2 = GameSprite('images/exit.png', win_width - 85, 100, 80, 80)
...
coin1_2 = GameSprite('images/coin.jpg', 300, 200, 80, 80)
coin2_2 = GameSprite('images/coin.jpg', 100, 600, 80, 80)
coins_2.add(coin1_2)
coins_2.add(coin2_2)
...
while run:
    if a == "menu":
        ...
        exit_but.update(mouse_pos, "images/exit.png", 200, 80)
        ...
        if not finish:
            ...
            if sprite.spritecollide(hero, monsters, False):
                ...
                lose.play()
                mixer.music.stop()
                img = image.load('images/game_over.jpg')
        ...
        if not finish:
            ...
            if sprite.collide_rect(hero_2, final_sprite_2):
                ...
                win.play()
                mixer.music.stop()
                img = image.load('images/winner.jpg')
                window.blit(transform.scale(img, (win_width, win_height)), (0, 0))
